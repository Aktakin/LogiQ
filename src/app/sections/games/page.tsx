...
export default function GamesSection() {
  ...
  return (
    <main className="min-h-screen min-h-[100dvh] p-4 sm:p-6 md:p-8 relative bg-gradient-to-b from-cyan-950/50 via-slate-950 to-slate-950">
      <FloatingShapes />
      ...
      >
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="glass px-4 py-2 rounded-xl text-center">
            <span className="text-gray-400 text-sm">{funGames.length} games</span>
          </div>
        </div>
      </motion.header>
      ...
      >
        <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br from-cyan-600/50 to-teal-600/30 mb-4">
          <span className="text-4xl">🎮</span>
        </div>
        <h1 className="text-3xl sm:text-4xl font-bold text-white mb-2">Fun Games</h1>
        <p className="text-gray-400 text-sm sm:text-base max-w-xl mx-auto">
          Enjoy exciting arcade and puzzle games while learning valuable skills!
        </p>
      </motion.div>
      ...
      >
        ...
        {/* More games coming banner */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.4 }}
          className="mt-8 glass rounded-2xl p-6 text-center border border-cyan-500/30"
        >
          <span className="text-4xl mb-3 block">🎮</span>
          <h3 className="text-lg font-bold text-white mb-1">More games coming soon!</h3>
          <p className="text-gray-400 text-sm">We're always adding new fun games to play.</p>
        </motion.div>
      </motion.section>
    </main>
  );
