...
const categories: Category[] = [
  ...
  },
  {
    ...
    description: 'Nest functions inside functions — tighter caps, deeper composition!',
    icon: '🧬',
    color: '#6366f1',
    bgGradient: 'from-indigo-600/25 to-violet-600/20',
    levels: 15,
    completed: 0,
    locked: false,
    comingSoon: false,
    path: '/games/programming/functions-2',
  },
  {
    id: 'event-pond',
